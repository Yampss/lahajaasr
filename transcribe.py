...
class TranscriptionConfig:
    ...
    pretrained_name: str = "stt_hi_conformer_ctc_medium"  # Name of a pretrained model
    audio_dir: Optional[str] = None # Path to a directory which contains audio files
    dataset_manifest: str = "/content/lahaja_manifest.json"  # Path to dataset's JSON manifest
